...
const TroubleshootingFlowchart = () => {
  return (
    <Card className="p-6 bg-gradient-to-br from-gray-900 to-gray-800 border-gray-700 rounded-[24px]">
      ...
      <div className="h-[800px] bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg border border-gray-700 shadow-xl overflow-hidden">
        <ReactFlow
          nodes={nodes}
          edges={edges}
          fitView
