...
const SmartSystemGuide = () => {
  return (
    <div className="bg-[#0B1221] rounded-[32px] border border-gray-800/30 p-8 mt-12">
      <div className="space-y-8">
        <div className="space-y-2">
          <h2 className="text-[2rem] font-medium text-[#60A5FA] leading-tight">
        ...
        <div className="space-y-4 pt-4">
          <AccordionItem value="bluetooth" className="border-b border-gray-800/50 py-4">
            <div className="flex items-center gap-3">
              <svg className="w-5 h-5 text-[#60A5FA]" viewBox="0 0 24 24" fill="none">
                <path d="M12 15L16 11L12 7V15Z" fill="currentColor"/>
                <path d="M12 19V15L8 11L12 7V3L4 11L12 19Z" fill="currentColor"/>
              </svg>
              <AccordionTrigger className="text-[#60A5FA] text-xl hover:no-underline flex-1">
                Bluetooth Connectivity
                <ChevronDown className="h-6 w-6 shrink-0 text-[#4ADE80] transition-transform duration-200" />
              </AccordionTrigger>
            </div>
            <AccordionContent>
              <BluetoothSection />
        ...
        <div className="pt-4">
          <Link to="/documentation">
            <Button 
              variant="outline" 
              className="bg-transparent border-[#60A5FA] text-[#60A5FA] hover:bg-[#60A5FA]/10 text-base py-4 px-6"
            >
