    ...
    <div className="bg-[#0B1221] rounded-[32px] border border-gray-800/30 p-8 mt-8">
      <div className="space-y-6">
        ...
        <div className="space-y-0 pt-2 border rounded-lg border-gray-800/50">
          <AccordionItem value="bluetooth" className="border-b border-gray-800/50 px-4 py-3">
            <div className="flex items-center gap-3">
              <svg className="w-4 h-4 text-[#60A5FA]" viewBox="0 0 24 24" fill="none">
          ...
          <AccordionItem value="software" className="border-b border-gray-800/50 px-4 py-3">
            <div className="flex items-center gap-3">
              <svg className="w-4 h-4 text-[#60A5FA]" viewBox="0 0 24 24" fill="none">
          ...
          <AccordionItem value="power" className="border-b border-gray-800/50 px-4 py-3">
            <div className="flex items-center gap-3">
              <svg className="w-4 h-4 text-[#60A5FA]" viewBox="0 0 24 24" fill="none">
          ...
          <AccordionItem value="connectivity" className="px-4 py-3">
            <div className="flex items-center gap-3">
              <svg className="w-4 h-4 text-[#60A5FA]" viewBox="0 0 24 24" fill="none">
