...
const SmartSystemGuide = () => {
  return (
    <div className="bg-[#0B1221] rounded-[32px] border border-gray-800/30 p-12 mt-24">
      <div className="space-y-12">
        <div className="space-y-4">
          <h2 className="text-[3.5rem] font-medium text-[#60A5FA] leading-tight">
        ...
        <div className="space-y-6 pt-8">
          <AccordionItem value="bluetooth" className="border-b border-gray-800/50 py-6">
            <div className="flex items-center gap-4">
              <svg className="w-8 h-8 text-[#60A5FA]" viewBox="0 0 24 24" fill="none">
                <path d="M12 15L16 11L12 7V15Z" fill="currentColor"/>
                <path d="M12 19V15L8 11L12 7V3L4 11L12 19Z" fill="currentColor"/>
              </svg>
              <AccordionTrigger className="text-[#60A5FA] text-3xl hover:no-underline flex-1">
                Bluetooth Connectivity
                <ChevronDown className="h-10 w-10 shrink-0 text-[#4ADE80] transition-transform duration-200" />
              </AccordionTrigger>
            </div>
            <AccordionContent>
              <BluetoothSection />
          ...
          <AccordionItem value="software" className="border-b border-gray-800/50 py-6">
            <div className="flex items-center gap-4">
              <svg className="w-8 h-8 text-[#60A5FA]" viewBox="0 0 24 24" fill="none">
          ...
          <AccordionItem value="power" className="border-b border-gray-800/50 py-6">
            <div className="flex items-center gap-4">
              <svg className="w-8 h-8 text-[#60A5FA]" viewBox="0 0 24 24" fill="none">
          ...
          <AccordionItem value="connectivity" className="border-b border-gray-800/50 py-6">
            <div className="flex items-center gap-4">
              <svg className="w-8 h-8 text-[#60A5FA]" viewBox="0 0 24 24" fill="none">
        ...
        <div className="pt-8">
          <Link to="/documentation">
            <Button 
              variant="outline" 
              className="bg-transparent border-[#60A5FA] text-[#60A5FA] hover:bg-[#60A5FA]/10 text-xl py-6 px-8"
            >
