      ...
      <div className="max-w-6xl mx-auto">
        <OptimizedAffiliateGrid
          ...
          partners={[
            ...
            { name: 'Overland Solar', url: 'https://overlandsolar.com', title: 'Overland Solar', description: 'Complete off-grid solar solutions for adventure vehicles with premium quality and support', buttonText: 'Go Solar Today' },
            ...
            { name: 'Nomad Internet', url: 'https://nomadinternet.com', title: 'Nomad Internet', description: 'Unlimited 5G internet plans designed specifically for full-time RV travelers and remote workers', buttonText: 'Get Unlimited Data' }
          ]}
          gridCols="3"
        />
