  ...
  return (
    <div className="sticky top-0 z-10 bg-[#091020] py-2 md:py-4 shadow-lg">
      <TabsList className="bg-[#091020] p-1 md:p-2 w-full flex flex-wrap justify-center gap-1 md:gap-2">
        <TabsTrigger 
          value="power" 
          className="relative z-20 data-[state=active]:bg-[#60A5FA] data-[state=active]:text-white text-gray-300 hover:text-white font-semibold text-sm md:text-base px-2 md:px-4 py-1.5 md:py-2 flex-1 min-w-[120px] md:min-w-[140px] max-w-[200px]"
