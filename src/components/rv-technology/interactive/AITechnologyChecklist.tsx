...
export const AITechnologyChecklist: React.FC = () => {
  ...
  const generateDownload = () => {
    ...
    const addFooter = () => {
      ...
      doc.text('Generated by Smart RV Hub AI Technology Consultant', pageWidth / 2, pageHeight - 10, { align: 'center' });
    ...
    doc.text('Smart RV Hub', pageWidth / 2, 25, { align: 'center' });
    
    doc.setFontSize(20);
    doc.text('AI Technology Research Checklist', pageWidth / 2, 45, { align: 'center' });
    ...
    doc.setFontSize(14);
    doc.setFont('helvetica', 'bold');
    doc.text('Budget Considerations', margin, yPosition);
    yPosition += 10;
    
    doc.setFontSize(10);
    doc.setFont('helvetica', 'normal');
    const budgetLines = doc.splitTextToSize(result.budgetConsiderations, pageWidth - 2 * margin);
    doc.text(budgetLines, margin, yPosition);
    yPosition += budgetLines.length * 5 + 15;
    ...
    doc.text('Technology Checklist', margin, yPosition);
    yPosition += 12;
    ...
    doc.setFont('helvetica', 'bold');
    doc.setTextColor(91, 155, 213);
    doc.text('General Questions for RV Dealers', margin, yPosition);
    yPosition += 10;
