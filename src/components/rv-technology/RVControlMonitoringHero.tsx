  ...
  return (
    <div className="relative w-full h-[500px] md:h-[600px] overflow-hidden my-12">
      <PreloadedHeaderImage 
        src={rvControlImage}
        alt="Modern RV interior with advanced control and monitoring systems featuring digital displays and smart interfaces"
      ...
      <div className="absolute inset-0 flex items-center justify-center z-20">
        <div className="text-center max-w-5xl px-6">
          ...
          <p className="text-lg md:text-xl text-white/80 max-w-4xl mx-auto image-overlay-headline">
            Understanding what's actually available versus marketing promises helps buyers make informed technology decisions.
          </p>
        </div>
      </div>
    </div>
...
export default RVControlMonitoringHero;