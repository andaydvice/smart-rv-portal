  ...
  return (
    <div className="relative w-full h-[500px] md:h-[600px] overflow-hidden my-12">
      <PreloadedHeaderImage 
        src={rvPowerImage}
        alt="Modern RV with advanced power management technology including solar panels and battery systems in desert landscape"
...
export default RVPowerManagementHero;