...
import { Calculator, Cloud, Archive, ClipboardCheck, ShoppingBag, Store, Brain } from 'lucide-react';
...
const RVToolsLinks: React.FC<RVToolsLinksProps> = ({ className }) => (
  <div className={`grid gap-3 ${className || ''}`}>
    <NavLink to="/rv-tools" className="text-gray-300 hover:text-blue-400 transition-colors flex items-center gap-2">
      <Brain className="h-4 w-4 text-[#5B9BD5]" />
      <span>Interactive RV Tools</span>
    </NavLink>
