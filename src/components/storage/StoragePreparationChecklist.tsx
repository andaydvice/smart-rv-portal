        ...
        <Card className="border-gray-700 bg-[#091020] shadow-xl overflow-hidden">
          <CardHeader className="border-b border-gray-700 pb-6 bg-gradient-to-r from-[#0c1219] to-[#131a2a]">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6">
              <div className="flex gap-2">
                <Button variant="outline" className="gap-2 bg-[#151A22] hover:bg-[#1d2532] text-[#E2E8FF] border-gray-700">
                ...
                <Button variant="outline" className="gap-2 bg-[#151A22] hover:bg-[#1d2532] text-[#E2E8FF] border-gray-700" onClick={handleReset}>
          ...
          <CardContent className="pt-6">
            <Tabs defaultValue="rv-info" className="space-y-8">
              <TabsList className="bg-[#151A22] p-1 mb-8 grid grid-cols-2 md:grid-cols-5 lg:flex overflow-x-auto">
