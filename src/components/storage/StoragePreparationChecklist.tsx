        ...
        <Card className="border-gray-700 bg-[#091020] shadow-xl overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6">
              <div className="flex gap-2">
                <Button 
                  ...
                  focus:text-white focus:bg-[#1d2532] focus:border-[#5B9BD5]
                  active:text-white active:bg-[#2d3545] active:border-[#5B9BD5]"
                >
          ...
          <CardContent className="pt-6">
            <Tabs defaultValue="rv-info" className="space-y-8">
              <TabsList className="bg-[#151A22] mb-8 grid grid-cols-2 md:grid-cols-5 lg:flex overflow-x-auto py-8 px-4">
