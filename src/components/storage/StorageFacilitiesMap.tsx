    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 min-h-[800px] map-content-wrapper">
      ...
      <div className="lg:col-span-8 flex flex-col space-y-4">
        ...
        <div className="flex justify-between items-center">
          <div className="text-white bg-[#F97316] px-4 py-3 rounded-md text-sm shadow-md border-2 border-white/20 animate-pulse font-medium flex items-center gap-2 max-w-md">
            ...
            <span>If location details cut off, move the map with your browser</span>
          </div>
          <button 
