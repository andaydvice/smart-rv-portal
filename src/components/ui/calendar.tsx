  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: "h-9 w-9 text-center text-sm p-0 relative text-white [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20",
        day: cn(
        ...
        day_today: "bg-accent text-accent-foreground text-white",
        day_outside:
          "day-outside text-white opacity-50 aria-selected:bg-accent/50 aria-selected:text-white aria-selected:opacity-30",
        day_disabled: "text-muted-foreground opacity-50 text-white",
        day_range_middle:
          "aria-selected:bg-accent aria-selected:text-accent-foreground text-white",
