...
export const HeroSection = () => (
  <section className="relative min-h-screen w-screen max-w-full overflow-hidden">
    ...
    <motion.div
      ...
      className="relative z-10 text-left text-white px-4 max-w-5xl mx-auto h-full flex items-center"
    >
