...
const TechnologySection = () => {
  ...
  const handleCardClick = (link: string) => {
    if (import.meta.env.DEV) console.log('Card clicked, navigating to:', link);
  ...
  return (
    <>
      <section className="py-24 px-4 bg-gradient-to-br from-[#2A2A4A] to-[#1A1A2F] relative overflow-hidden" style={{ contentVisibility: "auto", containIntrinsicSize: "1000px" }}>
        <div className="absolute inset-0 bg-[url('/lovable-uploads/0a22c848-dff2-43f4-b1eb-800fa123a904.webp')] opacity-5 bg-cover bg-gray-900" style={{ backgroundColor: '#111827' }} />
      ...
      {/* Technology product recommendations removed */}
    </>
  );
};
