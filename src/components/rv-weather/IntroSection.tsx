...
const IntroSection = () => {
  return (
    <section id="weather-matters" className="py-6 px-4 rounded-lg bg-white border border-[#e2e8f0] shadow-sm">
      <div className="flex items-center gap-2 mb-4">
        <Cloud className="h-7 w-7 text-[#3b82f6]" />
        <TypographyH2 className="border-none text-[#1a202c] text-left text-3xl">Why Weather Matters for RV Travel</TypographyH2>
      </div>
      
      <TypographyP className="text-[#4a5568] text-base sm:text-lg text-left mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="p-6 bg-[#f8fafc] rounded-lg transition-all hover:bg-[#f1f5f9] hover:transform hover:-translate-y-1">
          <div className="text-4xl text-[#3b82f6] mb-4 flex justify-center">
          ...
          <p className="text-[#4a5568] text-left">
        ...
        <div className="p-6 bg-[#f8fafc] rounded-lg transition-all hover:bg-[#f1f5f9] hover:transform hover:-translate-y-1">
          ...
          <h3 className="text-xl font-bold mb-4 text-center">Campsite Comfort</h3>
          <p className="text-[#4a5568] text-left">
        ...
        <div className="p-6 bg-[#f8fafc] rounded-lg transition-all hover:bg-[#f1f5f9] hover:transform hover:-translate-y-1">
          ...
          <h3 className="text-xl font-bold mb-4 text-center">Vehicle Longevity</h3>
          <p className="text-[#4a5568] text-left">
