  ...
  return (
    <section className="py-6 px-4 rounded-lg bg-gradient-to-b from-[#131a2a]/50 to-[#080F1F]/50 border border-[#1a202c]/40 backdrop-blur-sm">
      <div className="flex items-center gap-2 mb-4">
        ...
        <TypographyH2 className="border-none text-white text-left">Why Weather Matters for RV Travel</TypographyH2>
      </div>
      <TypographyP className="text-light-blue text-base sm:text-lg text-left">
