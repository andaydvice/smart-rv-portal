  ...
  return (
    <section className="py-6 px-4 rounded-lg bg-gradient-to-b from-[#131a2a]/50 to-[#080F1F]/50 border border-[#1a202c]/40 backdrop-blur-sm">
      <div className="flex items-center gap-2 mb-6">
        ...
        <TypographyH2 className="border-none text-white text-left">Real-Time Weather Monitoring</TypographyH2>
      </div>
      
      <div className="space-y-6">
        <div>
          <TypographyH4 className="text-white text-left">Essential Weather Apps</TypographyH4>
          <div className="grid gap-4 mt-4 md:grid-cols-2">
            <div className="p-4 rounded-lg border border-[#1a202c] bg-[#080F1F]/70">
              <h5 className="font-semibold text-[#5B9BD5] text-left">Comprehensive Weather Apps</h5>
              <ul className="mt-2 space-y-1 text-sm text-light-blue list-disc list-inside text-left">
            ...
            <div className="p-4 rounded-lg border border-[#1a202c] bg-[#080F1F]/70">
              <h5 className="font-semibold text-[#5B9BD5] text-left">RV-Specific Weather Tools</h5>
              <ul className="mt-2 space-y-1 text-sm text-light-blue list-disc list-inside text-left">
