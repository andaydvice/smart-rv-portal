  ...
  return (
    <div className="lg:col-span-1 space-y-6">
      ...
      <div className="bg-gray-800 text-white rounded-lg shadow p-6">
        ...
        <div className="space-y-4">
          <div>
            <h5 className="text-sm font-semibold text-[#3b82f6] mb-1">Spring</h5>
          ...
          <div>
            <h5 className="text-sm font-semibold text-[#3b82f6] mb-1">Summer</h5>
          ...
          <div>
            <h5 className="text-sm font-semibold text-[#3b82f6] mb-1">Fall</h5>
          ...
          <div>
            <h5 className="text-sm font-semibold text-[#3b82f6] mb-1">Winter</h5>
      ...
      <div className="bg-gray-800 text-white rounded-lg shadow p-6">
        <div className="flex items-center gap-2 mb-4">
          <Book className="h-5 w-5 text-[#3b82f6]" />
          <h3 className="font-bold text-lg">Weather Resources</h3>
        </div>
        
        <div className="space-y-2">
          <a href="https://www.weather.gov/safety/" target="_blank" rel="noopener noreferrer" className="flex items-center text-blue-400 hover:underline">
            <span className="text-xs">→ NOAA Weather Safety</span>
          </a>
          <a href="https://www.ready.gov/severe-weather" target="_blank" rel="noopener noreferrer" className="flex items-center text-blue-400 hover:underline">
            <span className="text-xs">→ Ready.gov Severe Weather</span>
          </a>
          <a href="https://rvlifestyle.com/" target="_blank" rel="noopener noreferrer" className="flex items-center text-blue-400 hover:underline">
            <span className="text-xs">→ RV Weather Safety Webinars</span>
          </a>
          <a href="https://escapees.com/" target="_blank" rel="noopener noreferrer" className="flex items-center text-blue-400 hover:underline">
