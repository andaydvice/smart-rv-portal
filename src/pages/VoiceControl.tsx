...
const VoiceControl = () => {
  console.log("VoiceControl component rendering - fixing section order to match design");
  ...
  return (
    <div className="min-h-screen bg-[#0A0E17] text-white">
      <main className="relative w-full">
        ...
        {/* Voice Control Systems Cards */}
        <section className="py-16 bg-[#1A1F2E33]">
          <h2 className="text-4xl font-bold text-center my-12">Voice Control Systems</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
