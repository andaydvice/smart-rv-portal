    ...
    <div className="min-h-screen bg-[#0A0E17] text-white">
      <main className="relative w-full">
        ...
        <section className="py-20 bg-[#0B1121]">
          <h2 className="text-4xl font-bold text-center mb-16">Benefits of Voice Control</h2>
          ...
          <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-[#151B2E] rounded-2xl p-8 flex flex-col items-start">
              ...
              <p className="text-gray-300">Control your RV systems without lifting a finger</p>
            </div>

            <div className="bg-[#151B2E] rounded-2xl p-8 flex flex-col items-start">
              <Shield className="text-[#3B82F6] mb-4 w-6 h-6" />
              <h3 className="text-2xl font-semibold mb-4">Enhanced Safety</h3>
              <p className="text-gray-300">Keep your focus on driving and surroundings</p>
            </div>

            <div className="bg-[#151B2E] rounded-2xl p-8 flex flex-col items-start">
              <MessageSquare className="text-[#3B82F6] mb-4 w-6 h-6" />
              <h3 className="text-2xl font-semibold mb-4">Personalization</h3>
              <p className="text-gray-300">Customize commands to your preferences</p>
            </div>

            <div className="bg-[#151B2E] rounded-2xl p-8 flex flex-col items-start">
              <Smartphone className="text-[#3B82F6] mb-4 w-6 h-6" />
              <h3 className="text-2xl font-semibold mb-4">Smart Device Integration</h3>
              <p className="text-gray-300">Seamless connection with your devices</p>
            </div>

            <div className="bg-[#151B2E] rounded-2xl p-8 flex flex-col items-start">
              <Sun className="text-[#3B82F6] mb-4 w-6 h-6" />
              <h3 className="text-2xl font-semibold mb-4">Efficiency</h3>
              <p className="text-gray-300">Streamline your RV management</p>
            </div>

            <div className="bg-[#151B2E] rounded-2xl p-8 flex flex-col items-start">
              <HomeIcon className="text-[#3B82F6] mb-4 w-6 h-6" />
              <h3 className="text-2xl font-semibold mb-4">Accessibility</h3>
              <p className="text-gray-300">Make RV control easier for everyone</p>
            </div>
          </div>
        </section>
