  ...
  return (
    <Layout>
      ...
      <div className="min-h-screen w-full bg-[#080F1F] text-white">
        {/* Hero Header with Image - Now absolutely positioned with fixed height */}
        <div className="relative w-full h-[300px] marker-free-zone no-markers-allowed">
          <img 
        ...
        {/* Map container with proper spacing from header - FIXED SPACING HERE */}
