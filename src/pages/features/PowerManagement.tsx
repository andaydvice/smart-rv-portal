      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-gray-800/50 p-8 rounded-lg border border-gray-700">
            <h2 className="text-2xl font-semibold text-yellow-400 mb-4">Smart Energy Distribution</h2>
            <p className="text-gray-300 mb-6">
              Our intelligent power management system optimizes your energy usage with:
            </p>
