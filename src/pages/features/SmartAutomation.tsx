          ...
          <div className="bg-gray-800/30 p-8 rounded-lg border border-gray-700 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-4 bg-gray-800/50 rounded-lg flex flex-col items-center text-center">
                ...
                <p className="text-[#E2E8FF]">Seamless integration with lighting, climate control, entertainment, and security systems.</p>
              </div>
              <div className="p-4 bg-gray-800/50 rounded-lg flex flex-col items-center text-center">
                <WifiIcon className="h-8 w-8 text-[#5B9BD5] mb-3" />
                <h3 className="text-xl font-medium text-white mb-2">Connectivity</h3>
                <p className="text-[#E2E8FF]">Reliable connectivity with mobile app control and cloud-based management.</p>
              </div>
              <div className="p-4 bg-gray-800/50 rounded-lg flex flex-col items-center text-center">
                <BatteryCharging className="h-8 w-8 text-[#5B9BD5] mb-3" />
                <h3 className="text-xl font-medium text-white mb-2">Power Management</h3>
                <p className="text-[#E2E8FF]">Intelligent power distribution with real-time monitoring and automated efficiency.</p>
              </div>
            </div>
          </div>
