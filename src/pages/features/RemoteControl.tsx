...
const RemoteControl = () => {
  ...
  useEffect(() => {
    ...
    const criticalImages = [
      ...
      '/lovable-uploads/927988b5-f130-4e93-847b-20474831470d.webp', // Control interface 
      '/lovable-uploads/7b0c607c-52e6-47d2-b5fa-f5cbb912f20a.webp'  // New interface demo image
    ];
